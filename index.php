                ...
                <h3>Iniciar sesión en su cuenta</h3>
                    ...
                    <form action="./controllers/register_login.php" method="POST">
                        <div class="form-group form-box">
                            <input type="email" name="correo" class="input-text" placeholder="Correo Electrónico"> 
                        </div>
                        <div class="form-group form-box">
                            <input type="password" name="password" class="input-text" placeholder="Contraseña"> 
                        </div>
                        <div class="form-group mb-0 clearfix">
                            <button type="submit" name="entrar" class="btn-md btn-theme btn-block">Iniciar Sesión </button> 
                        </div>
                    ...
                    <p>Tienes Cuenta? <a href="./pages/register.php" class="thembo">Nuevo Usuario</a></p>
